...
<section id="body-content">
	...
	<?php while (have_posts()) : the_post(); ?>
		...
		<article class="block">
			...
			<?php if (get_field('socialdataweek_article_content')): ?>
 
				<?php while(has_sub_field('socialdataweek_article_content')): ?>
					
					<div class="row">
						<?php the_sub_field('socialdataweek_article_content_field'); ?>
					</div>
